--Query 1 - Buscar o nome e o ano dos filmes
SELECT Nome, Ano FROM Filmes

--Query 2 - Buscar o nome, o ano e a duração dos filmes, ordenados por ordem crescente pelo ano
SELECT Nome, Ano, Duracao FROM Filmes
ORDER BY Ano

--Query 3 - Buscar pelo filme de volta para o futuro, trazendo o nome, o ano e a duração
SELECT Nome, Ano, Duracao FROM Filmes
...
--Query 6 - Buscar os filmes com a duração maior que 100 e menor que 150, ordenando pela duração em ordem crescente
SELECT Nome, Ano, Duracao FROM Filmes
WHERE Duracao > 100 AND Duracao < 150
ORDER BY Duracao

--Query 7 - Buscar a quantidade de filmes lançados no ano, agrupando por ano e ordenando pela quantidade em ordem decrescente
